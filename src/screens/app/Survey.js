...
export default function Survey() {
    ...
    useEffect(() => {
        fetch('https://gist.githubusercontent.com/kelsupdate/0043c419c6f1687bc101f8ae9f0bead1/raw/2e797dded2a26d553ed495e7d93b45d80639f1a7/gistfile1.txt')
                ...
                </Grid>
                {
                    surveyComplete
                        ...
                        <Card sx={{ mt: 1 }}>
                            ...
                            <LottieEarned />
                            <Button style={{ backgroundColor: '#bbc46eff' }} onClick={navigateHome} sx={{ mt: 1 }} fullWidth>Continue</Button>
                        </Card>
                        :
                        <div>
                            {
