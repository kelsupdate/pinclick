...
const Register = () => {
  ...
  return (
    <Box sx={{ 
      minHeight: '100vh',
      background: 'linear-gradient(135deg, #cde4ebff 0%, #cbedf1ff 100%)',
      display: 'flex',
      alignItems: 'center',
      py: 4
    }}>
      <Container maxWidth="sm">
        <Paper elevation={3} sx={{ p: 4, borderRadius: 3 }}>
          <Box sx={{ textAlign: 'center', mb: 3 }}>
            <PersonAddIcon sx={{ fontSize: 60, color: '#267dafff', mb: 2 }} />
          ...
          <form onSubmit={handleSubmit}>
            ...
            <Button
              ...
              sx={{
                ...
                borderRadius: 2,
                '&:hover': {
                  backgroundColor: '#256ca7ff'
                },
                '&:disabled': {
                  backgroundColor: '#7facb9ff'
                }
              }}
            >
