  ...
  const testimonials = [
    {
      ...
      earnings: 'Kes 2,000',
      avatar: '👩‍💼',
      text: 'Prolific Survey changed my life! I earn 2000+ weekly just by sharing my opinions.'
    },
    {
      name: 'John Kinyua.',
      earnings: 'Kes 4,500',
      ...
      <Container maxWidth="lg" sx={{ py: 8 }}>
        <Box sx={{ textAlign: 'center', mb: 6 }}>
          <Typography variant="h1" sx={{ 
            ...
            Start Earning with Prolific Survey
          </Typography>
        ...
        <Box sx={{ display: 'flex', justifyContent: 'center', gap: { xs: 2, md: 4 }, mb: 8, flexWrap: 'wrap' }}>
          <Box sx={{ textAlign: 'center' }}>
            <Typography variant="h3" sx={{ color: '#3175a3ff', fontWeight: 'bold' }}>50K+</Typography>
            <Typography variant="body1" sx={{ color: '#666' }}>Active Users</Typography>
          </Box>
          <Box sx={{ textAlign: 'center' }}>
            <Typography variant="h3" sx={{ color: '#3088b1ff', fontWeight: 'bold' }}>$2M+</Typography>
            <Typography variant="body1" sx={{ color: '#666' }}>Total Payouts</Typography>
          </Box>
          <Box sx={{ textAlign: 'center' }}>
            <Typography variant="h3" sx={{ color: '#367ca5ff', fontWeight: 'bold' }}>4.9★</Typography>
            ...
            {features.map((feature, index) => (
              <Grid item xs={12} sm={6} md={4} key={index}>
                <Card sx={{ 
                  ...
                  '&:hover': {
                    boxShadow: '0 4px 8px rgba(42, 115, 163, 0.2)'
                  }
                }}>
                  <CardContent>
                    <Box sx={{ mb: 2 }}>{feature.icon}</Box>
                    <Typography variant="h6" sx={{ mb: 1, color: '#2b7597ff', fontWeight: 'bold' }}>
                      {feature.title}
                    </Typography>
                ...
                <Card sx={{ 
                  ...
                  <CardContent sx={{ textAlign: 'center' }}>
                    <Avatar sx={{ 
                      ...
                      mx: 'auto', 
                      mb: 2,
                      backgroundColor: '#2a79a7ff',
                      fontSize: 30
                    }}>
                      {testimonial.avatar}
                    </Avatar>
                    <Typography variant="h6" sx={{ mb: 1, color: '#1f84a3ff', fontWeight: 'bold' }}>
                      {testimonial.name}
                    </Typography>
